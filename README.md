...
- 🔭 Recent research centers on the **NASA C-MAPSS** dataset for joint anomaly detection, fault classification, and remaining-useful-life prediction
- 🩺 Building medical imaging pipelines combining CNNs, transformers, and graph attention networks
- 🛠 Work primarily in **PyTorch**, prototype in **Google Colab** on GPU
- 🔐 Also trained in offensive security — VAPT, OWASP Top 10, incident response
- 📄 Published researcher with a filed patent in edge-deployed anomaly detection
...
| Area | Focus |
|:---:|:---|
| 🤖 **GenAI** | Generative AI applications & LLM-driven workflows |
| 📚 **LLMs** | Prompt engineering & agentic tooling |
| ✈️ **Predictive Maintenance** | Fault detection & RUL prediction on NASA C-MAPSS |
| 🩻 **Medical AI** | CT / PET-based diagnostic imaging models |
| 💻 **Placement Prep** | Java DSA for technical interviews |
...
**Internship Trainee** — *Razz Security, Bengaluru*
`Jan 2024 – Apr 2024`
...
- Performed Vulnerability Assessment & Penetration Testing (VAPT) using Burp Suite, Nmap, and Metasploit
- Identified and mitigated OWASP Top 10 vulnerabilities (SQL Injection, XSS, CSRF)
- Conducted incident response tasks including log analysis and threat detection
- Applied foundational malware analysis and detection techniques
...
<details open>
<summary><b>🚗 Multi-Modal Graph RAG for Driver Safety Monitoring</b></summary>
<br>

Analyzes visual, sensor, and contextual data for improved risk detection.

`Python` `Graph RAG` `LLMs` `PyTorch` `OpenCV` `NetworkX`

</details>

<details>
<summary><b>🤖 Smart Interview Preparation Agent</b></summary>
<br>

AI-powered interview prep system with dynamic question generation & performance tracking, built on LLM workflows.

`Python` `LLMs` `Activepieces` `OpenAI API` `Prompt Engineering` `REST APIs`

</details>

<details>
<summary><b>🌍 Context-Aware Tourist Recommendation System</b></summary>
<br>

Real-time recommendation engine using a Decision Tree model, integrating weather APIs and user preferences.

`Python` `Flask` `Decision Tree` `JavaScript` `OpenStreetMap API` `Weather API`

</details>

<details>
<summary><b>🧠 NLP-based Language Detection, Readability & Bias Analysis</b></summary>
<br>

Interactive dashboard for language detection, sentiment analysis, readability scoring, and bias analysis.

`Python` `FastText` `VADER` `TextStat` `Pandas` `Matplotlib` `Flask`

</details>

<details>
<summary><b>⚙️ ETL Data Pipeline for Analytics</b></summary>
<br>

Automated pipeline for data extraction, transformation, and validation to improve data reliability.

`Python` `SQL` `MySQL` `Pandas` `ETL`

</details>

<details>
<summary><b>🚀 CI/CD Pipeline for Deployment Automation</b></summary>
<br>

Automated build, test, and deploy pipeline that reduced manual release errors.
...
**System and Method for Low-Power Real-Time Video Anomaly Detection Deployment on an Edge Computing Platform**
<br><sub>Indian Patent Application No. 202641084253 · Filed 09 Jul 2026 · Co-Inventor · M.S. Ramaiah Institute of Technology</sub>
...
<br><sub>ICEFEET 2026 — Accepted</sub>

</td></tr>
<tr><td>

**Scalable Fault Detection in Aircraft Engines via Sequence Modelling and Attention-based Autoencoding**
<br><sub>IC-SIIT 2026 — Accepted</sub>
...
|:---|:---|:---:|:---:|
| B.E. Computer Science & Engineering (AI & ML) | M. S. Ramaiah Institute of Technology, Bengaluru | 2024 – 2027 | 8.82 <sub>(till 5th sem)</sub> |
...
<details>
<summary><b>View all 7 certifications</b></summary>
<br>

- Internship Certification — Razz Security
- Google Hackathon Workshop Participant — Google AI Studio & Google Antigravity
